...
-- Tiempo de generación: 03-04-2018 a las 19:14:45
...
CREATE TABLE IF NOT EXISTS `ciudad` (
  ...
  PRIMARY KEY (`id`),
  KEY `provincia_id_fk` (`provincia_id`) USING BTREE
...
CREATE TABLE IF NOT EXISTS `cliente` (
  ...
  `trabajo_telefono` varchar(255) NOT NULL,
  `ciudad_id` bigint(20) DEFAULT NULL,
  `user_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK1le6orj8lrio9vg2jdayn5kqy` (`ciudad_id`),
  KEY `FK51q58w7p2gonvu6xsuyp3t2bo` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `descuento` (`id`, `valor`, `orden`) VALUES
(1, 10, 1),
(3, 23, 2);
...
INSERT INTO `interes` (`id`, `valor`, `orden`) VALUES
(4, 7, 1);
...
(7, 'global.clave', 'ab', 'Clave Global', 'Constantes', 'String'),
(8, 'random.number.bound', '0123456789ABCDEF', 'Random number bound', 'Constantes', 'String'),
(9, 'spring.mail.subject.forgot', 'Datos de acceso', 'Subject forgot mail', 'Bean', 'String'),
(10, 'spring.mail.subject.new', 'Nuevo usuario', 'Subject new mail', 'Bean', 'String'),
(11, 'spring.mail.subject.new.pass', 'Nueva contraseña', 'Subject new pass mail', 'Bean', 'String'),
(12, 'spring.mail.body', '<h3 style=\"color: brown;\">Consejo Profesional de Agrimensura de Rio Negro</h3>', 'Body mail', 'Bean', 'String'),
(13, 'spring.mail.body.acceso', ' Su contraseña de acceso es:', 'Contraseña de acceso mail', 'Bean', 'String'),
(14, 'spring.mail.msj.activar', '<h4>Para activar el usuario ingrese al siguiente link: </h4>', 'Mensaje activar mail', 'Bean', 'String'),
(15, 'backup.pathSQL', 'C:\\\\wamp64\\\\bin\\\\mysql\\\\mysql5.7.14\\\\bin\\\\mysqldump ', 'path sql installer', 'backup', 'String'),
(16, 'backup.command', '-uroot -proot --add-drop-database -B financiera_dev -r ', 'Comando con user y pass de la base', 'backup', 'String'),
(17, 'backup.pathBack', 'C:\\\\Users\\\\Federico\\\\Desktop\\\\backup\\\\financiera.sql', 'Carpeta donde guarda el archivo', 'Backup', 'String');
...
INSERT INTO `usuario` (`id`, `active`, `email`, `intentos_de_login`, `password`, `rol`, `username`) VALUES
(1, b'1', 'fdifabio@unrn.edu.ar', 0, '$2a$10$1Q0W/xiQ/K/IFemChUsE3u5wBoliRpnMzFgKr9jFUoJTGkhJOneBi', 'ROLE_ADMIN', 'fdifabio@unrn.edu.ar');
